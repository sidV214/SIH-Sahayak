...
import InteractiveMap from "./components/interactive-map"; // Default import
...
export default function App() {
  ...
  const renderCurrentPage = () => {
    switch (currentPage) {
      ...
      case "map":
        return <InteractiveMap />; // Render InteractiveMap
      case "community":
      ...
      <div className="min-h-screen bg-background">
        {showOfflineBanner && !isOnline && (
          <Alert className="rounded-none border-orange-200 bg-orange-50 text-orange-800">
            ...
            <AlertDescription>
              You're currently offline. The app will sync your data when
          ...
          <main className="flex-1 overflow-auto">
            <div
              className={`min-h-full ${
                showOfflineBanner && !isOnline ? "pt-14" : ""
              }`}
            >
              {renderCurrentPage()}
            </div>
